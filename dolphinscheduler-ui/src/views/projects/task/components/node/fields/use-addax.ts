...
export function useAddax(model: { [field: string]: any }): IJsonItem[] {
  const { t } = useI18n()
  ...
  return [
    {
      type: 'switch',
      field: 'customConfig',
      name: t('project.node.addax_custom_template')
    },
    ...useDatasource(model, {
      typeField: 'dsType',
    ...
    },
    {
      type: 'editor',
      field: 'json',
      name: t('project.node.addax_json_template'),
      span: jsonEditorSpan,
      validate: {
        trigger: ['input', 'trigger'],
        required: true,
    ...
    }),
    {
      type: 'input',
      field: 'targetTable',
      name: t('project.node.addax_target_table'),
      span: destinationDatasourceSpan,
      props: {
        placeholder: t('project.node.addax_target_table_tips')
      },
      validate: {
        trigger: ['input', 'blur'],
        required: true
    ...
    },
    {
      type: 'multi-input',
      field: 'preStatements',
      name: t('project.node.addax_target_database_pre_sql'),
      span: otherStatementSpan,
      props: {
        placeholder: t('project.node.addax_non_query_sql_tips'),
        type: 'textarea',
        autosize: { minRows: 1 }
      }
    },
    {
      ...
      name: t('project.node.addax_target_database_post_sql'),
      span: otherStatementSpan,
      props: {
        placeholder: t('project.node.addax_non_query_sql_tips'),
        type: 'textarea',
    ...
    },
    {
      type: 'select',
      field: 'jobSpeedByte',
      name: t('project.node.addax_job_speed_byte'),
      span: jobSpeedSpan,
    ...
    },
    {
      ...
      name: t('project.node.addax_job_speed_record'),
      span: jobSpeedSpan,
    ...
    },
    {
      type: 'select',
      field: 'jobChannel',
      name: t('project.node.addax_job_channel'),
      span: jobSpeedSpan,
