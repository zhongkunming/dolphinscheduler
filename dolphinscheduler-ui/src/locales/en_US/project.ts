...
export default {
  ...
  workflow: {
    ...
    whether_complement_data: 'Whether it is a complement workflow?',
  ...
  dag: {
    ...
    workflow_execute_type: 'Workflow execute type',
    parallel: 'parallel',
    serial_wait: 'Serial wait',
  ...
  node: {
    ...
    grpc_message_tips_not_correspond2proto:
      'Message content does not conform to proto format',
    grpc_check_condition: 'gRPC Check Condition',
    grpc_status_code_default: 'Default status code OK',
    grpc_status_code_custom: 'Custom status code',
    grpc_condition: 'gRPC Condition',
    grpc_condition_tips: 'Please Enter gRPC Condition',
    http_url: 'Http Url',
    ...
    addax_custom_template: 'Custom Template',
    addax_json_template: 'JSON',
    addax_target_datasource_type: 'Target Datasource Types',
    addax_target_database: 'Target Database',
    addax_target_table: 'Target Table',
    addax_target_table_tips: 'Please enter the name of the target table',
    addax_target_database_pre_sql: 'Pre SQL Statement',
    addax_target_database_post_sql: 'Post SQL Statement',
    addax_non_query_sql_tips: 'Please enter the non-query sql statement',
    addax_job_speed_byte: 'Speed(Byte count)',
    addax_job_speed_byte_info: '(0 means unlimited)',
    addax_job_speed_record: 'Speed(Record count)',
    addax_job_speed_record_info: '(0 means unlimited)',
    addax_job_channel: 'addax channel',
    addax_job_runtime_memory: 'Runtime Memory Limits',
    addax_job_runtime_memory_xms: 'Low Limit Value',
    addax_job_runtime_memory_xmx: 'High Limit Value',
    addax_job_runtime_memory_unit: 'M',
