...
export default {
  ...
  node: {
    ...
    grpc_credential_type: 'gRPC 凭证类型',
    grpc_credential_type_insecure: '不安全',
    grpc_credential_type_tls_default: '客户端系统SSL/TLS',
    grpc_method: '方法名称',
    ...
    grpc_message_tips_not_correspond2proto: '消息内容不匹配Protobuf格式',
    grpc_check_condition: '校验条件',
    grpc_status_code_default: '默认状态码OK',
    grpc_status_code_custom: '自定义状态码',
    grpc_condition: '校验内容',
    grpc_condition_tips: '请填写校验内容',
    http_url: '请求地址',
    ...
    addax_custom_template: '自定义模板',
    addax_json_template: 'JSON',
    addax_target_datasource_type: '目标源类型',
    addax_target_database: '目标源实例',
    addax_target_table: '目标表',
    addax_target_table_tips: '请输入目标表名',
    addax_target_database_pre_sql: '目标库前置SQL',
    addax_target_database_post_sql: '目标库后置SQL',
    addax_non_query_sql_tips: '请输入非查询SQL语句',
    addax_job_speed_byte: '限流(字节数)',
    addax_job_speed_byte_info: '(KB，0代表不限制)',
    addax_job_speed_record: '限流(记录数)',
    addax_job_speed_record_info: '(0代表不限制)',
    addax_job_channel: '数据管道数',
    addax_job_runtime_memory: '运行内存',
    addax_job_runtime_memory_xms: '最小内存',
    addax_job_runtime_memory_xmx: '最大内存',
    ...
    emr_serverless_application_id_tips: '请输入 EMR Serverless Application ID',
    emr_serverless_execution_role_arn: '执行角色 ARN',
    emr_serverless_execution_role_arn_tips: '请输入 IAM 执行角色 ARN',
